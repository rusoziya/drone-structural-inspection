...
def verify_marker_and_adjust(drone_interface: SingleNodeDroneMission,
    ...
    After successful verification, resets the stored detected marker.
    """
    ...
    # Reset the detected marker so that next verification will wait for a new detection.
    drone_interface.detected_marker_id = None
    return True
