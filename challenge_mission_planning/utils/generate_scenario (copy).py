...
#
# This script generates a random Gazebo scenario configuration with obstacles
# and viewpoints, and saves it as a YAML file in the same folder as the script.
#
# Assumptions:
# - Obstacles are cuboids with center (x, y, z) and dimensions (d, w, h).
# - Viewpoint poses are generated randomly outside the obstacles.
# ------------------------------------------------------------------------------
...
def save_scenario_to_yaml(scenario, file_name):
    """Save the scenario to a YAML file in the same folder as this script."""
...
def main():
    ...
    parser.add_argument("--num_viewpoints", type=int, default=10, help="Number of random viewpoints to generate.")
    parser.add_argument("--num_obstacles", type=int, default=50, help="Number of random obstacles to generate.")
    ...
    # Save to a YAML file in the same folder as this script
